...
{let submenu_items=fetch( content, list, hash( parent_node_id, $module_result.path[2].node_id,
                                                       class_filter_type, include,
